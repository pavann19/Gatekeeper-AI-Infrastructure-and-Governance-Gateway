...
def force_judge_required(monkeypatch):
    ...
    # Below every threshold on purpose — see test_llama_guard_arbitration.py's
    # identical fixture comment: the Stage 1.5 fast-path cascade must not
    # escalate before this test's mocked collect_semantic_signals runs.
